...
// Komponen internal yang aman menggunakan hook
function LoginForm() {
    ...
    <div className="w-full max-w-md p-10 bg-white rounded-2xl shadow-xl space-y-8 border border-gray-100">
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        ...
        <button
          ...
          className={`w-full py-3 px-4 rounded-lg font-semibold text-white tracking-wide transition ${loading ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}`}
        >
...
// Komponen utama yang diekspor, membungkus LoginForm dengan Suspense
